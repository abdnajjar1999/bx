...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const Color bgDefault = Color(0xFFF6F3EC);
    const Color textPrimary = Color(0xFF1A1C1E);
    const Color textSecondary = Color(0xFF5E6278);
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: const Color(0xFFD34E17),
