...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  final _taxNumberController = TextEditingController(text: "");
  final _apiUsernameController = TextEditingController(text: "");
  final _apiPasswordController = TextEditingController(text: "");
  final _activityController = TextEditingController(text: "");
