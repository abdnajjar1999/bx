import 'package:sadrad/screens/AddOrder/AddOrderFormOne.dart';
...
class _ShipmentReceiptDialogState extends State<ShipmentReceiptDialog> {
  ...
  Widget _buildDeliveryDataItem(
    ...
    return ListTile(
      ...
      tileColor: isSelected ? Color(0xFF4F46E5).withOpacity(0.1) : null,
                  ...
                  children: [
                    ...
                    _buildTableCell(
                      shipment.status == 'تم إرجاعها'
                          ? (shipment.receivedMoneyFromCustomer
                              ? '${shipment.deliveryCost} (أجور)'
                              : '0.00')
                          : '${shipment.codAmount}',
                    ),
  ...
  Widget _buildStatusBadge(String status) {
    ...
    switch (status.toLowerCase()) {
      case 'تم توصيلها':
        bgColor = Color(0xFF4F46E5).withOpacity(0.1);
