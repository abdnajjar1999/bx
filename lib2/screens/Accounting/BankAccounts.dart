                    ...
                    if (!showAccounts) ...[
                      ...
                      Card(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              const Icon(Icons.filter_list, color: Color(0xFF4F46E5)),
                              const SizedBox(width: 8),
                              const Text(
                                'تصفية بالتاريخ:',
                                  ...
                                  children: [
                                    Expanded(
                                      child: ElevatedButton.icon(
                                        ...
                                        icon: Icon(
                                          ...
                                          color: _fromDate != null ? Color(0xFF4F46E5) : Colors.grey,
                                        ),
                                        label: Text(
                                          _fromDate != null
                                              ...
                                              : 'من تاريخ',
                                          style: TextStyle(
                                            color: _fromDate != null ? Color(0xFF4F46E5) : Colors.grey.shade700,
                                            fontWeight: _fromDate != null ? FontWeight.bold : FontWeight.normal,
                                          ),
                                        ),
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: _fromDate != null ? Color(0xFF4F46E5).withOpacity(0.1) : Colors.grey.shade50,
                                          side: BorderSide(
                                            color: _fromDate != null ? Color(0xFF4F46E5) : Colors.grey,
                                          ),
                                        ),
                                    ...
                                    Expanded(
                                      child: ElevatedButton.icon(
                                        ...
                                        icon: Icon(
                                          Icons.calendar_today,
                                          color: _toDate != null ? Color(0xFF4F46E5) : Colors.grey,
                                        ),
                                        label: Text(
                                          _toDate != null
                                              ...
                                              : 'إلى تاريخ',
                                          style: TextStyle(
                                            color: _toDate != null ? Color(0xFF4F46E5) : Colors.grey.shade700,
                                            fontWeight: _toDate != null ? FontWeight.bold : FontWeight.normal,
                                          ),
                                        ),
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: _toDate != null ? Color(0xFF4F46E5).withOpacity(0.1) : Colors.grey.shade50,
                                          side: BorderSide(
                                            color: _toDate != null ? Color(0xFF4F46E5) : Colors.grey,
                                          ),
                                        ),
            ...
            cells: [
                      ...
                      DataCell(
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: balance >= 0 ? Color(0xFF4F46E5).withOpacity(0.1) : Colors.red.shade50,
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(
                              color: balance >= 0 ? Color(0xFF4F46E5).withOpacity(0.3) : Colors.red.shade200,
                            ),
                          ),
                          child: Text(
                            ...
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: balance >= 0 ? Color(0xFF4F46E5) : Colors.red.shade700,
                            ),
                          ),
                        ),
                      ),
                ...
                children: [
                  ...
                  Expanded(
                    child: _buildSummaryCard(
                      ...
                      netAmount >= 0 ? Color(0xFF4F46E5) : Colors.red,
                    ),
                  ),
                ],
              ),
                              ...
                              DataCell(
                                Container(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: transfer.type == 'إيداع' ? Color(0xFF4F46E5) : Colors.red,
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 14,
                                      color: transfer.type == 'إيداع' ? Color(0xFF4F46E5) : Colors.red.shade700,
                                    ),
                                  ),
                                ),
                              ),
