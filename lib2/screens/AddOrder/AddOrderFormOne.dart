...
class AddOrderFormState extends State<AddOrderFormOne> {
  ...
  void _handleSubmit(AppProvider appProvider) async {
    ...
    try {
      ...
      String initialStatus = 'الطلبات الجديدة';
      ...
      final shipmentData = Shipment(
          orderId: _isEditMode
              ...
              : now.millisecondsSinceEpoch.toString().replaceRange(0, 2, ''),
          ...
          driverId: (selectedPickupLocation == 'مع السائق' &&
                  appProvider.selectedDriver != null)
              ? appProvider.selectedDriver!.userid
              : (_isEditMode
                  ? widget.shipment!.driverId
                  : driverInfo['driverId']),
          driverName: (selectedPickupLocation == 'مع السائق' &&
                  appProvider.selectedDriver != null)
              ? appProvider.selectedDriver!.username
              : (_isEditMode
                  ? widget.shipment!.driverName
                  : driverInfo['driverName']),
          packageAttributes: packageAttributes,
          deliveryCost: double.tryParse(deliveryCostController.text) ?? 0,
          ...
          codAmount: double.tryParse(codAmountController.text) ?? 0,
          ...
          createdAt: _isEditMode ? widget.shipment!.createdAt : now,
          lastUpdated: now,
      ...
      if (_isEditMode) {
        ...
        Map<String, dynamic> updateMap = {
          ...
          'lastUpdated': shipmentData.lastUpdated.toIso8601String(),
          'deliveryDate': shipmentData.deliveryDate?.toIso8601String(),
          'expectedDeliveryDate':
          ...
          'logs': FieldValue.arrayUnion([
            {
              ...
              'text': 'تم تحديث معلومات الشحنة',
              'status': null, // Do not change status in logs or main field
              'userName': userName,
            }
          ]),
        };
  ...
  Widget _buildSectionTitle(String title) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(getIconForSection(title), color: Color(0xFF4F46E5)),
    ...
    return Row(
      ...
      children: [
        ...
        Row(
          children: [
            IconButton(
              icon: Icon(Icons.remove_circle_outline, color: Color(0xFF4F46E5)),
              onPressed: () {
            ...
            Text('$parcelCount'),
            IconButton(
              icon: Icon(Icons.add_circle_outline, color: Color(0xFF4F46E5)),
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: Color(0xFF4F46E5), width: 1),
                    ),
                    child: Text(
