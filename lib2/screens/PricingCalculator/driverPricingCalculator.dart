...
class DriverPricingCalculator extends StatefulWidget {
  const DriverPricingCalculator({Key? key}) : super(key: key);

  @override
  State<DriverPricingCalculator> createState() =>
      _DriverPricingCalculatorState();
}

class _DriverPricingCalculatorState extends State<DriverPricingCalculator> {
          ...
          children: [
            Row(
              children: [
                ...
                Flexible(
                  child: Container(
                    ...
                    child: DropdownButton2<Driver>(
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  setState(() {
                                    ...
                                    appProvider.selectedDriverShippingRoute =
                                        appProvider
                                                .driverShippingRoutes.isNotEmpty
                      ...
                      items: appProvider.drivers.map((Driver value) {
                      ...
                      onChanged: (value) {
                        setState(() {
                          appProvider.selectedDriver = value!;
                ...
                TextButton.icon(
                  onPressed: () =>
                      appProvider.exportPricesToExcel(context, isDriver: true),
            ...
            Expanded(
              ...
              child: DataTable(
                ...
                rows: appProvider.selectedDriverShippingRoute?.shippingRoute
                        .map((route) => DataRow(
                              cells: [
              ...
              NewPricingEntryForm(
                ...
                onSubmit: (route) {
                  if (_editingRoute != null) {
                    ...
                    appProvider.updatePriceCalculator(route, isDriver: true);
                  }
                },
              ),
          ],
