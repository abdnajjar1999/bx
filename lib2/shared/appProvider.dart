// import 'package:sadrad/aiAgent/aiAgentSidePanal.dart';
import 'package:sadrad/aiAgent/aiAgentSidePanal.dart';
import 'package:sadrad/aiAgent/tools.dart';
...
class AppProvider extends ChangeNotifier {
  ...
  Future<void> assignDriver(String orderId, Driver driver) async {
    await firebaseHelper.assignDriver(orderId, driver);
    notifyListeners();
  }
  ...
  Future<void> updateOrderStatus(
    ...
    await firebaseHelper.updateOrderStatus(orderId, status, driver, note,
  ...
  Future<void> init() async {
    ...
    listenToSettings();
    listenToExcelConfigs(); // Add this line
  }
    ...
    try {
      ...
      ShippingRoute? matchingRoute = customerRoute.shippingRoute.firstWhere(
        (route) {
          ...
          // Also check reverse
          bool reverseToMatch = routeFrom == cleanCityName ||
              (normParentCity != null && routeFrom == normParentCity);
          bool reverseFromMatch =
              customerCity != null && routeTo == customerCity;

          return (reverseToMatch && reverseFromMatch);
        },
        orElse: () {
